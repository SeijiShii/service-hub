...
| [revise_chart-colors_20260608_series-palette/](./revise_chart-colors_20260608_series-palette/) | revise | chart-colors | **設計完了 (2026-06-08) / 実装待ち** | chart 線色 palette (`CHART_SERIES_COLORS`) を **暖寒交互順に並べ替え** + near-dup (シアン#34d3a0≒緑#34d399) 解消 + 紫追加。色数8維持。先頭3色が青〜緑に固まり 2〜3 service で「青と緑だけ」に見える問題を解消。純視覚・互換維持・migration 不要・revert で rollback | [INDEX](./revise_chart-colors_20260608_series-palette/INDEX.md) |
