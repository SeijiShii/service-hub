...
| [revise_last-deploy-col_20260530_chart-to-column/](./revise_last-deploy-col_20260530_chart-to-column/) | revise | last-deploy-col | 設計完了 (2026-05-30、tdd 待ち) | `last_deploy_at` を上部 chart から除外 (4→3 枚) し、下部一覧テーブルに**「最終デプロイ」日時カラム**を additive 追加。デプロイ時刻は単一値で折れ線不向きのため timeseries-topchart の一部を差し戻し。表示層のみ・DB/公開 API 不変 | [INDEX](./revise_last-deploy-col_20260530_chart-to-column/INDEX.md) |
