...
共通型定義 (ServiceDescriptor / UsageMetric / ProviderKind / SnapshotRow)
...
|---|---|---|---|---|---|
| [revise_favicon-projection_20260528/](./revise_favicon-projection_20260528/) | revise | favicon-projection | 実装完了 (2026-05-28、Phase 1-4 unit 255 green、5th deploy 待ち) | service-info contract v1→v2 (iconUrl 追加) + services.icon_url + public-status DTO 投影 + safeUrl 共通化 + ProviderAdapter 拡張 (R1-R9 反映) | [INDEX](./revise_favicon-projection_20260528/INDEX.md) |
