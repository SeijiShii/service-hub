...
| 4 | ❌ | [dashboard](./dashboard/) | 実装済+デプロイ済 / 改修4件（admin-ux + nav-and-pull + last-deploy-col 実装完了+9th deploy 済 / biz-charts 設計完了 tdd 待ち） | 2026-05-30 | [INDEX](./dashboard/INDEX.md) |
