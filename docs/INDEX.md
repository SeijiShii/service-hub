...
| 4 | ❌ | [dashboard](./dashboard/) | 実装済+デプロイ済 / 改修6件（admin-ux + nav-and-pull + last-deploy-col + biz-charts + tip-metrics(C20260607-001) + chart-ux(時間軸統一+期間選択+usd系chart削除、unit 331 green) 実装完了 / E2E 待ち） | 2026-06-08 | [INDEX](./dashboard/INDEX.md) |
