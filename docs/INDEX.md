...
| 4 | ❌ | [dashboard](./dashboard/) | 実装済+デプロイ済 / 改修1件 実装完了（admin-ux, unit 179）+ 改修1件設計完了（nav-and-pull: 双方向 navigation + 「今すぐ pull」を dashboard へ relocation） | 2026-05-28 | [INDEX](./dashboard/INDEX.md) |
