...
| 4 | ❌ | [dashboard](./dashboard/) | 実装済+デプロイ済 / 改修7件（admin-ux + nav-and-pull + last-deploy-col + biz-charts + tip-metrics(C20260607-001) + chart-ux(unit 331 green) + chart-colors(線色palette並べ替え、unit 337 green) 実装完了 / chart-colors E2E 待ち） | 2026-06-08 | [INDEX](./dashboard/INDEX.md) |
