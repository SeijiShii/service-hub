...
| 4 | ❌ | [feedback-inbox](./feedback-inbox/) | 実装+E2E+視覚 green + **本番反映済 (21st deploy)** [論点-007]/O67 / 改修3件 (inbox-ux + inbox-pull-source shipped、inquiries-reply-channel 実装完了 unit 427 green: inquiries 消費で email 返信導線、E2E 待ち) | 2026-06-19 | [INDEX](./feedback-inbox/INDEX.md) |
