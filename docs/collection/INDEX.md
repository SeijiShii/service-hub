...
|---|---|---|---|---|---|
| [revise_force-pull_20260528_admin-button/](./revise_force-pull_20260528_admin-button/) | revise | force-pull | 実装完了 (unit 194 passed) | アプリ内強制プルボタン（/admin に「今すぐ pull」、新 `api/admin/collect.ts` Clerk ゲート、cron 経路は無変更） | [INDEX](./revise_force-pull_20260528_admin-button/INDEX.md) |
