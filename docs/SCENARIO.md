...
- デプロイ状況: ✅ 公開 URL = https://service-hub.givers.work (custom domain、Clerk production、live キー稼働中、**18th deploy = feedback-inbox 本番反映済**、feedback_items 列 db:push 済、post-deploy smoke green = frontend 200 / public-status 200 / feedback-inbox 401 authed / dashboard 401)。
